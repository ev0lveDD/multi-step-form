export default function StepFooter({nextStep, previousStep, currentStep, setCurrentStep, checkFunction}){
    return(
        <div className="w-full bg-white md:bg-transparent h-16 md:h-auto fixed md:static bottom-0 left-0 md:bottom-auto md:left-auto md:pt-6 m-0 p-0 md:pb-3 flex items-center justify-center">
