...
export default function Menu({currentStep}){
    return(
        <div className="h-40 md:h-96 w-full md:w-1/3 lg:w-1/4 bg-pattern-desktop bg-auto md:bg-cover bg-center md:rounded m-0 md:m-4 flex md:flex-col justify-center md:justify-start gap-3 md:gap-0">
